...
import { ChevronLeft, ChevronRight, Menu, Copy, Settings, Eye, Save, Upload, Sun, Moon } from "lucide-react"
            ...
            <div className="flex h-8 sm:h-14 items-center px-2 sm:px-4">
                ...
                <div className="ml-auto flex items-center gap-1 sm:gap-2">
                    ...
                    <Button
                        variant="ghost"
                        size="sm"
                        onClick={() => navigator.clipboard.writeText(`https://linktr.ee/${username}`)}
