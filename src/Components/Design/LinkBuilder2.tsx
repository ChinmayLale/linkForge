        ...
        switch (link.type) {
            case "music":
                return (
                    <div
                        key={link.id}
                        className={`${baseClasses} ${styleClasses} p-4 rounded-2xl`}
                        style={{
                    ...
                    >
                        <div className="flex items-center gap-4">
                            <div className="relative">
                                ...
                                >
                                    {playingMusic === link.id ? <Pause className="w-4 h-4" /> : <Play className="w-4 h-4" />}
                                </Button>
                            </div>
                            ...
                            <div className="flex gap-1">
                                <Button size="sm" variant="ghost" className="w-8 h-8 p-0 opacity-60 hover:opacity-100">
                ...
                return (
                    ...
                    >
                        <div className="relative">
                            ...
                            <Badge className="absolute top-2 right-2 bg-black/60 text-white">{link.metadata?.duration}</Badge>
                        </div>
                        <div className="p-4">
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1">
                                ...
                                <div className="flex items-center gap-2 text-xs opacity-70 mb-2">
                                    ...
                                    <span>{link.metadata?.location}</span>
                                </div>
                                <p className="text-xs opacity-80">{link.metadata?.description}</p>
                            </div>
                            <Button size="sm" variant="ghost" className="bg-white/20 hover:bg-white/30 text-xs px-3">
                                Get Tickets
                            </Button>
                        </div>
                    </div>
                ...
                return (
                    ...
                    >
                        <div className="flex items-center justify-center gap-3">
                            ...
                            {link.type === "social" && <ExternalLink className="w-4 h-4 opacity-60" />}
                        </div>
                    </div>
                )
        }
                                        ...
                                        <div className="relative">
                                            ...
                                            <div className="px-6 py-8">
                                                ...
                                                <div className="text-center mb-8">
                                                    ...
                                                    <h1 className="text-xl font-bold mb-2" style={{ color: theme.textColor }}>
                                                        {profile.name}
                                                    </h1>
                                                    <p className="text-sm opacity-80 mb-4" style={{ color: theme.textColor }}>
                                                        {profile.bio}
                                                    </p>
