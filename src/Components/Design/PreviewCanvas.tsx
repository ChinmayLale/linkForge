    ...
    switch (previewMode) {
      ...
      case "tablet":
        return screenSize === "mobile"
          ...
          : "w-[768px] h-[1024px]";
      case "desktop":
        return "w-full max-w-[1440px] min-h-[100vh]";
      default:
            ...
            >
              ...
              >
                <div className="px-4 sm:px-6 py-6 sm:py-8 h-full">
                  <div className="text-center mb-6 sm:mb-8">
                    <div className="relative inline-block mb-3 sm:mb-4">
                      <img
                        src={
                          profile.avatar ||
                          "https://images.unsplash.com/photo-1744878150591-6ebf3a050d4f?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxmZWF0dXJlZC1waG90b3MtZmVlZHwxMnx8fGVufDB8fHx8fA%3D%3D"
                        }
                        alt={profile.name}
                  ...
                  <div
                    className="text-center mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-white/20"
                    onClick={() => {
                      setSelectedElement();
                    }}
                  >
